...
(1) $R$ 的定义域，记作 $\operatorname{dom}(R)$，定义为 $\operatorname{dom}(R) = \lbrace x\mid \exists y,\ xRy\rbrace$。    
(2) $R$ 的值域，记作 $\operatorname{ran}(R)$，定义为 $\operatorname{ran}(R) = \lbrace y\mid \exists x,\ xRy\rbrace$。    

例如，设 $R= \lbrace (2,1),(1,2),(1,3),(2,3), (4,3),(4,1),(1,5), (5,1),(0,2),(5,0),(3,4) \rbrace$ 则 $\operatorname{dom}(R) = \lbrace 2,1,4,5,0,3\rbrace\operatorname{ran}(R) = \lbrace 1,2,3,5,0,4\rbrace$。    
