...
则：
 $\begin{aligned} A \cap B &= \lbrace b\rbrace \\ A \cap D &= \lbrace a, b\rbrace \\ B \cap D &= \lbrace b, d\rbrace \\ C \cap D &= \varnothing \end{aligned}​$
...
**证明** 仅证结合律以示范，其余留作习题。根据外延公理，需证 $A \cap ( B \cap C ) \subseteq ( A \cap B ) \cap C$ 且 $( A \cap  B ) \cap C  \subseteq A \cap ( B \cap C )$。    
...
$\begin{aligned} A \cup B &= \lbrace a,b,c,d,e\rbrace \\ A \cup C &= \lbrace a,b,c,e,g\rbrace \\ B \cup C &= \lbrace b,c,d,e,g\rbrace \\ C \cup D &= \lbrace a,b,c,d,e,f,g\rbrace \end{aligned}$
