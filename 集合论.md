...
对于任意非空集合 $A$，存在集合 $B$，使得 $B=\lbrace x\mid \forall y\in A,\ x\in y\rbrace$。
...
**引理 2.2.1**
设 $a,b,c,d$ 为集合，则 $(a,b)=(c,d)$ 当且仅当 $a=c, b=d$。
...
**习题 2.2.1**     
证明： $(x,y,z)=(s,t,u)$ 当且仅当 $x=s,y=t,z=u$。    
...
**定理 2.2.1**
对于任意两个集合 $A,B$， $\lbrace (a,b)\mid a\in A,\ b\in B\rbrace$ 是一个集合。称其为 $A$ 与 $B$ 的**笛卡儿积**（Cartesian product），记作 $A\times B$。
...
于是 $(a,b) = \lbrace \lbrace a\rbrace ,\lbrace a,b\rbrace \rbrace$ 是 $\mathcal P(A\cup B)$ 的一个子集。故 $(a,b) \in \mathcal P(\mathcal P(A\cup B))$。因此，任意满足 $a\in A,\ b\in B$ 的有序对 $(a,b)$ 都属于 $\mathcal P(\mathcal P(A\cup B))$。从而 $A\times B = \Bigl\lbrace  x\in\mathcal P(\mathcal P(A\cup B)) \ \Big|\ \exists a\in A,\exists b\in B,\ x=(a,b) \Bigr\rbrace$。    
...
**习题 2.2.2**     
设 $A=\lbrace 1,2,3,4\rbrace , \qquad B=\lbrace 2,3,4,5\rbrace$，求 $A\times B$。    

**习题 2.2.3**    
设集合 $A$ 恰含有 $n$ 个元素，集合 B 恰含有 $m$ 个元素，问 $A\times B$ 含有几个元素？        

**习题 2.2.4**    
设 $A\times B = B\times A$。证明： $A=\varnothing \quad\text{或}\quad B=\varnothing \quad\text{或}\quad A=B$。    
#### **2.2.3 二元关系**
#### **2.2.4 关系的运算**
#### **2.2.5 像与原像**
#### **2.2.6 等价关系**
