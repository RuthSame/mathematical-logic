...
(3)最小元至多只有一个。    
**证明**      
设 $a,b$ 都是最小元，则 $a\preceq b,\text{ }  b\preceq a$。再由偏序关系的反对称性，可以得到 $a=b$，因此最小元唯一。    
 ∎    
...
其中     
$\boxed{ \begin{aligned} \text{最小元}&\Longrightarrow\text{极小元},\\ \text{最大元}&\Longrightarrow\text{极大元}. \end{aligned} }$
但反向一般不成立。     
