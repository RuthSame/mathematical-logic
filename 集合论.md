...
事实上，当 $A=\varnothing$ 时， $x\in\bigcap\varnothing$ 意味着 $\forall y\in\varnothing,\ x\in y$由于空集中没有元素，这个命题对任意对象 $x$ 都成立（称为真空真）。
